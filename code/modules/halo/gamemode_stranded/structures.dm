...
/obj/structure/tanktrap
	name = "tanktrap"
	icon = 'code/modules/halo/gamemode_stranded/desert_outpost.dmi'
	icon_state = "tanktrap"
	density = 1
	anchored = 1
	throwpass = 1
...
/obj/structure/sandbag/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if(W.type in usable_tools)
		user.visible_message("<span class='notice'>You start deconstructing [src]...</span>",\
			"<span class='notice'>[user] starts deconstructing [src]...</span>")
		spawn(0)
