...
/obj/machinery/nuclearbomb/proc/explode()
	...
	if(ticker.mode && ticker.mode.name == "insurrection")
		var/obj/machinery/computer/shuttle_control/multi/innie/syndie_location = locate(/obj/machinery/computer/shuttle_control/multi/innie)
